...
namespace researcherApp
{
    public partial class Main : Form
    {
        ...
        public void Draw_grid(Graphics g)
        {
            ...
            g.DrawString("«н.", f, Brushes.Black, Cell_Position("«н.", f, 0,0));
            g.DrawString("—в.1", f, Brushes.Black, Cell_Position("—в.1", f, 0, 1));
        ...
        private void уменшить–азмерячеекToolStripMenuItem_Click(object sender, EventArgs e)
        {
            gridHeight -= 5;
            gridWidth -= 5;
            Draw_grid(grafx.Graphics);
        ...
        private void увеличить–азмерячеекToolStripMenuItem_Click(object sender, EventArgs e)
        {
            gridHeight += 5;
            gridWidth += 5;
            Draw_grid(grafx.Graphics);
        ...
        private void addToGrid_Click(object sender, EventArgs e)
        {
            ...
            if (grid_values.ContainsKey(Convert.ToInt32(addKey.Text)))
                MessageBox.Show("“аблица данных не может содержать два одинаковых значени€!", "ќшибка",MessageBoxButtons.OK, MessageBoxIcon.Error);
            else
            {
        ...
        private void очистить“аблицуToolStripMenuItem_Click(object sender, EventArgs e)
        {
            canDelete = false;
            table_values.Clear();
        ...
        private void показать¬ерхнююѕанельToolStripMenuItem_Click(object sender, EventArgs e)
        {
            splitContainer2.Panel1Collapsed = !splitContainer2.Panel1Collapsed;
            showTopPanel.Checked = !showTopPanel.Checked;
        }

        private void показатьЋевуюѕанельToolStripMenuItem_Click(object sender, EventArgs e)
        {
            splitContainer1.Panel1Collapsed = !splitContainer1.Panel1Collapsed;
            showLeftPanel.Checked = !showLeftPanel.Checked;
        }

        private void експорт“аблицыToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog.FileName != "")
            {
                ...
                ObjExcel.Cells[1, 1] = "«начени€";
                ObjExcel.Cells[2, 1] = "—войство1";
                for (int i = 1; i <= gridRows; i++)
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (grid_values.ContainsKey(Convert.ToInt32(textBox1.Text)))
            {
                if (table_values.Count == gridCols)
                {
                    MessageBox.Show("¬с€ таблица уже заполнена значени€ми!", "—ообщение", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                ...
                toolTip1.Show("¬водимое число должно быть с таблицы значений", textBox1, textBox1.Location.X-35 , textBox1.Location.Y-65, 3000);
        }
        ...
        private void количество—трокToolStripMenuItem1_DropDownClosed(object sender, EventArgs e)
        {
        ...
        private void количество—толбцовToolStripMenuItem_DropDownClosed(object sender, EventArgs e)
        {
